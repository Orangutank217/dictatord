...
echo -e "    Run '${YELLOW}dictatord --settings${NC}' to configure your hotkey"
echo -e "    Run '${YELLOW}dictatord --help${NC}' for all CLI options"
echo ""
echo -e "  ${BLUE}Configuration:${NC}"
echo -e "    Edit ${YELLOW}~/.config/dictatord/config.toml${NC}"
echo -e "    Run ${YELLOW}dictatord --settings${NC} for interactive setup"
echo ""
echo -e "  ${BLUE}Logs:${NC}"
...
echo ""
echo -e "  ${BLUE}Tips:${NC}"
echo -e "    - ${YELLOW}First step:${NC} pick a hotkey with 'dictatord --settings'"
echo -e "    - The first run downloads the Whisper model (~75 MB)"
